...
import de.vinogradoff.bgtultimate.domain.enumeration.Severity;
import de.vinogradoff.bgtultimate.repository.TicketRepository;
...
class TicketResourceIT {
    ...
    private static final Severity UPDATED_SEVERITY = Severity.MAJOR;
    ...
    void createTicket() throws Exception {
        ...
        assertThat(testTicket.getSeverity()).isEqualTo(DEFAULT_SEVERITY);
    }
    ...
    void putNewTicket() throws Exception {
        ...
        assertThat(testTicket.getSeverity()).isEqualTo(UPDATED_SEVERITY);
    }
